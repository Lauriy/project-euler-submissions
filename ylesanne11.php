<?php
	...
	$maatriks = array(
				...
				array(52, 70, 95, 23, 4, 60, 11, 42, 69, 24, 68, 56, 1, 32, 56, 71, 37, 02, 36, 91),
	...
	for($i = 0; $i < 20; $i++)
	{
		for($j = 0; $j < 17; $j++)
		{
			$korrutis = $maatriks[$i][$j] * $maatriks[$i][$j + 1] * $maatriks[$i][$j + 2] * $maatriks[$i][$j + 3];
			if($korrutis > $suurimkorrutis)
			{
				$suurimkorrutis = $korrutis;
			}
		}
	}
	...
	for($i = 0; $i < 17; $i++)
	{
		for($j = 0; $j < 20; $j++)
		{
			$korrutis = $maatriks[$i][$j] * $maatriks[$i + 1][$j] * $maatriks[$i + 2][$j] * $maatriks[$i + 3][$j];
			if($korrutis > $suurimkorrutis)
			{
				$suurimkorrutis = $korrutis;
			}
	...
	for($i = 0; $i < 17; $i++)
	{
		for($j = 0; $j < 17; $j++)
		{
			$korrutis = $maatriks[$i][$j] * $maatriks[$i + 1][$j + 1] * $maatriks[$i + 2][$j + 2] * $maatriks[$i + 3][$j + 3];
			if($korrutis > $suurimkorrutis)
			{
				$suurimkorrutis = $korrutis;
			}
